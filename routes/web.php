...
Route::resource('/sucursales', 'App\Http\Controllers\SucursalesController'); //crea todas la rutas de forma automatica
// Route::resource('/productos', 'App\Http\Controllers\ProductosController');

Route::get('/productos/create','App\Http\Controllers\ProductosController@create');//crear productos
